angular.module('taxi.services.controller', [])

.controller('TaxiServicesCtrl', ['$scope', '$ionicHistory', '$rootScope', '$ionicTabsDelegate', '$cordovaInAppBrowser', function($scope, $ionicHistory, $rootScope, $ionicTabsDelegate, $cordovaInAppBrowser) {
	...
	$scope.$on('$ionicView.enter', function() {
	    ...
	    $rootScope.subheading = "Taxi Services";
